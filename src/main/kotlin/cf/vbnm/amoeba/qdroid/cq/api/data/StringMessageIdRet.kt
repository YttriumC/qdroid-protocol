...
class StringMessageIdRet(
    ...
    @JsonProperty("data")
    data: MessageId
) : BaseApi<StringMessageIdRet.MessageId>(status, retcode, msg, wording, echo, data) {

    companion object {
        fun parseApiRet(map: Map<String, Any?>, objectMapper: ObjectMapper): BaseApi<*> {
            return objectMapper.convertValue(map, StringMessageIdRet::class.java)
        }
    }
