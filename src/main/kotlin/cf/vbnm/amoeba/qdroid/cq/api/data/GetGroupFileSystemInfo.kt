...
class GetGroupFileSystemInfo(
    ...
    @JsonProperty("data") data: GroupFileSystemInfo
    ...
    data class GroupFileSystemInfo(
        @JsonProperty("file_count") val fileCount: Long,
        @JsonProperty("limit_count") val limitCount: String,
        @JsonProperty("used_space") val usedSpace: Long,
        @JsonProperty("total_space") val totalSpace: Long,
    )
}