...
class GetGroupFilesByFolder(
    ...
    @JsonProperty("data")
    data: GroupFiles
) : BaseApi<GetGroupFilesByFolder.GroupFiles>(status, retcode, msg, wording, echo, data) {

    companion object {
        fun parseApiRet(map: Map<String, Any?>, objectMapper: ObjectMapper): BaseApi<*> {
            return objectMapper.convertValue(map, GetGroupFilesByFolder::class.java)
        }
    }
