...
class GetGroupHonorInfo(
    ...
    @JsonProperty("data") data: GroupHonorInfo
    ...
    data class GroupHonorInfo(
        ...
        @JsonProperty("current_talkative") val currentTalkative: CurrentTalkative?,
        @JsonProperty("talkative_list") val talkativeList: MutableList<OtherHonor>?,
        @JsonProperty("performer_list") val performerList: MutableList<OtherHonor>?,
        @JsonProperty("legend_list") val legendList: MutableList<OtherHonor>?,
        @JsonProperty("strong_newbie_list") val strongNewbieList: MutableList<OtherHonor>?,
        @JsonProperty("emotion_list") val emotionList: MutableList<OtherHonor>?,
    ) {
        data class CurrentTalkative(
            @JsonProperty("group_id") val groupId: Long,
            @JsonProperty("nickname") val nickname: String,
            @JsonProperty("avatar") val avatar: String,
            @JsonProperty("day_count") val dayCount: Int,
        )
