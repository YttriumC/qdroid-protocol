...
class GetEssenceMsgList(
    ...
    @JsonProperty("data") data: EssenceMsgListList
) : BaseApi<GetEssenceMsgList.EssenceMsgListList>(status, retcode, msg, wording, echo, data) {
    ...
    class EssenceMsgListList : ArrayList<EssenceMsgList>()

    data class EssenceMsgList(
        @JsonProperty("sender_id") val senderId: Long,
        @JsonProperty("sender_nick") val senderNick: String,
        @JsonProperty("sender_time") val senderTime: Long,
        @JsonProperty("operator_id") val operatorId: Long,
        @JsonProperty("operator_nick") val operatorNick: String,
        @JsonProperty("operator_time") val operatorTime: Long,
